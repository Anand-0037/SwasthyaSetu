#!/usr/bin/env python3
"""
Test script for your exact JSON data using ultra-fast endpoint
"""
...
# Your exact JSON data from the frontend
your_data = [
    {
        "uri": "3392171",
...
def test_ultra_fast_with_your_data():
    """Test the ultra-fast endpoint with your exact data"""
    print("🚀 Testing Ultra-Fast Endpoint with Your Braces Data")
    print("=" * 60)
    
    print(f"📊 Data Size: {len(json.dumps(your_data))} characters")
    print(f"📝 Questions: {len(your_data)}")
    print(f"💬 Answers: {sum(len(item.get('answers', [])) for item in your_data)}")
    
    try:
        start_time = time.time()
        
        print("\n🔄 Sending request to ultra-fast endpoint...")
...
if __name__ == "__main__":
    print("🏥 Medical Summarizer - Your Data Test")
    print("=" * 60)
    ...
    # Test ultra-fast endpoint with your data
    test_ultra_fast_with_your_data()
    
    # Test regular endpoint for comparison
    test_regular_endpoint_comparison()
    
    print("\n✨ Testing complete!")
    print("\n💡 The ultra-fast endpoint should process your braces data in under 1 second!")
